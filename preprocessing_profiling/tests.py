...
import six
import preprocessing_profiling
from preprocessing_profiling.describe import describe, describe_1d
from preprocessing_profiling.report import to_html
import tempfile
import shutil
import os
check_is_NaN = "preprocessing_profiling.check_is_NaN"
...
class DataFrameTest(unittest.TestCase):
	...
	def test_export_to_file(self):
		...
		p = preprocessing_profiling.ProfileReport(self.df)
